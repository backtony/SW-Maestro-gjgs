...
const mainCategoryImageUrl = [
  [require('gajigaksekapp/src/asset/iconImage/activity.png'), '액티비티'],
  [require('gajigaksekapp/src/asset/iconImage/cooking.png'), '쿠킹'],
  [require('gajigaksekapp/src/asset/iconImage/beautyHealth.png'), '뷰티/헬스'],
  [require('gajigaksekapp/src/asset/iconImage/dance.png'), '댄스'],
  [require('gajigaksekapp/src/asset/iconImage/art.png'), '미술'],
  [require('gajigaksekapp/src/asset/iconImage/handcraft.png'), '수공예'],
  [require('gajigaksekapp/src/asset/iconImage/music.png'), '음악/예술'],
];
...
class Category {
  ...
  public getMainCategoryImageUrl(main: string) {
    return mainCategoryImageUrl.filter(value => value[1] === main)[0][0];
  }
