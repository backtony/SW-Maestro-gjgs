...
interface GroupDetailFavoriteLectureListProps {
  navigation: any;
  title: string;
  data: any;
...
interface GroupDetailFavoriteLectureListStates {
  dropDowns: number[];
  data: any;
...
export default class GroupDetailFavoriteLectureList extends React.Component<
  GroupDetailFavoriteLectureListProps,
  GroupDetailFavoriteLectureListStates
> {
              ...
              <View style={this.styles.card}>
                <TouchableOpacity
                  ...
                  <View style={this.styles.cardContent}>
                    <Text style={this.styles.title}>{item.lecturesTitle}</Text>
                  </View>
                </TouchableOpacity>
                <DropDownPicker
