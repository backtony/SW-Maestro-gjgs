...
interface FavoriteZoneLectureViewLectureProps {
  navigation: any;
  lecture: any;
  onPress: () => void;
}

interface FavoriteZoneLectureViewLectureStates {
  dropDown: boolean;
}

export default class FavoriteZoneLectureViewLecture extends React.Component<
  FavoriteZoneLectureViewLectureProps,
  FavoriteZoneLectureViewLectureStates
> {
