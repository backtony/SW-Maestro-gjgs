...
interface HomeNewLectureListProps {
  navigation: any;
}

interface HomeNewLectureListStates {
  data: any;
  dropDowns: number[];
  favorites: number[];
...
export default class HomeNewLectureList extends React.Component<
  HomeNewLectureListProps,
  HomeNewLectureListStates
> {
  constructor(props: any) {
    ...
    this.getNewLectureList();
  }

  private async getNewLectureList() {
    const params = {
      page: 0,
      size: 4,
      zoneId: 3,
      categoryIdList: [3],
      sort: sortOrderList['최신순'],
    };
