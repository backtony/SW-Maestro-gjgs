...
import {sortOrderList} from '@/utils/commonParam';

interface HomePopularLectureListProps {
  navigation: any;
}

interface HomePopularLectureListStates {
  data: any;
  dropDowns: number[];
  favorites: number[];
...
export default class HomePopularLectureList extends React.Component<
  HomePopularLectureListProps,
  HomePopularLectureListStates
> {
  constructor(props: any) {
    ...
    this.getPopularLectureList();
  }

  private async getPopularLectureList() {
    const params = {
      page: 0,
      size: 4,
      zoneId: 3,
      categoryIdList: [2],
      sort: sortOrderList['인기높은순'],
    };
