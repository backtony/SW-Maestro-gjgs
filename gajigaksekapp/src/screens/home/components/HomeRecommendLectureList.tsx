...
interface HomeRecommendLectureListProps {
  navigation: any;
}

interface HomeRecommendLectureListStates {
  data: any;
  dropDowns: number[];
  favorites: number[];
...
export default class HomeRecommendLectureList extends React.Component<
  HomeRecommendLectureListProps,
  HomeRecommendLectureListStates
> {
  ...
  private async getMypageApi() {
    try {
      ...
      this.getRecommendLectureList(res?.data.memberCategoryIdList);
    } catch (e) {
      console.error(e);
    }
  }
