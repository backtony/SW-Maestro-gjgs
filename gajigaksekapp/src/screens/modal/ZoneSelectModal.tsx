...
export default class ZoneSelectModal extends React.Component<
  {
          ...
          <View style={this.modalStyles.modalView}>
                  ...
                  {Zone.getSubZoneList(this.state.selectedMainZone).map(
                    value => (
                      <TouchableOpacity
                        ...
                        style={[
                          this.modalStyles.button2,
                          this.state.selectedSubZone === value.sub
                            ? this.modalStyles.buttonOn
                            : this.modalStyles.buttonOff,
                        ]}
                        onPress={() => {
                          if (this.state.selectedSubZone === value.sub) {
                            this.setState({selectedSubZone: ''});
                          } else {
                            this.setState({selectedSubZone: value.sub});
                          }
                        }}>
                        <Text
                          style={[
            ...
            <View>
              <ScrollView
                ...
                showsVerticalScrollIndicator={false}
                showsHorizontalScrollIndicator={false}>
                <View style={this.modalStyles.wrapper3}>
                  <Text
